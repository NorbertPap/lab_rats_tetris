...
function moveAndTransformElement(event, board)
{
    let key = event.keyCode;
    // A = 65, D = 68, S = 83, Left Arrow = 37, Right Arrow = 39, Down Arrow = 40, Q = 81, E = 69
    switch(key)
    {
        // Left
        case 65:
        ...
        //Rotate Left
        case 81:
            rotateElement('left', board);
            break;
        //Rotate Right
        case 69:
            rotateElement('right', board);
            break;
    }
}
...
function main()
{
    ...
    document.addEventListener('keydown', function() { moveAndTransformElement(event, board) });
